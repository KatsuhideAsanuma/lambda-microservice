...
async fn main() -> std::io::Result<()> {
    ...
    HttpServer::new(move || {
        ...
        App::new()
            ...
            .app_data(web::Data::new(session_manager.clone() as Arc<dyn api::SessionManagerTrait>))
            .app_data(web::Data::new(runtime_manager.clone() as Arc<dyn api::RuntimeManagerTrait>))
